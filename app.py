...
def contact():
    ...
    # Ici, vous pouvez ajouter une logique pour traiter le formulaire (par exemple, envoyer un email)
    print(f"Message reçu de {name} ({email}): {message}")  # Simulation d'enregistrement
